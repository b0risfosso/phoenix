...
class Simulation:
    ...
    def make_static_scene(self):
        ...
        self.mem_rings = [
            torus(pos=vector(0, 0, 0), axis=vector(0, 0, 1), radius=CELL_R, thickness=0.012,
                  color=COL_MEMBRANE_EDGE, opacity=0.32),
            torus(pos=vector(0, 0, 0), axis=vector(0, 1, 0), radius=CELL_R, thickness=0.012,
                  color=COL_MEMBRANE_EDGE, opacity=0.24),
            torus(pos=vector(0, 0, 0), axis=vector(1, 0, 0), radius=CELL_R, thickness=0.012,
